...
type Debugger struct {
	DebuggerOptions DebuggerOptions `json:"debuggerOptions"`
...
func AddProcessor(processor *processors.Processor){
	if interceptor != nil{
		interceptor.Processors = append(interceptor.Processors, processor)
	}
}
